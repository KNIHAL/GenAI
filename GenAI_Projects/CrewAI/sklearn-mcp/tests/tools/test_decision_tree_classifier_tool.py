"""Unit tests for the decision tree classifier tool."""
...
from mcp_server_scikit_learn.tools.decision_tree_classifier_tool import (
...
async def test_handle_decision_tree_classifier_tool(
    mocker,
    scope_function,
    input_args: Dict[str, Any],
    expected_keys: list[str],
) -> None:
    """Test the decision tree classifier tool handler.
    ...
    # Call the handler
    result = await handle_decision_tree_classifier_tool(input_args)
