"""Unit tests for the random forest regressor tool."""
...
from mcp_server_scikit_learn.tools.random_forest_regressor_tool import (
...
async def test_handle_random_forest_regressor_tool(
    mocker,
    scope_function,
    input_args: Dict[str, Any],
    expected_keys: list[str],
) -> None:
    """Test the random forest regressor tool handler.
    ...
    # Call the handler
    result = await handle_random_forest_regressor_tool(input_args)
